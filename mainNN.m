...
%  Loading and visualizing the dataset of handwritten digits.
%
...
%  the cost only, then verifying the correct answer.
%
...
%  Starting with a function to initialize the weights of the neural network.
%
